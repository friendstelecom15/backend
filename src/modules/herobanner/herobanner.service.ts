...
export class HerobannerService {
    ...
    async findOneBottomBanner(id: string | ObjectId) {
        ...
        const bottomBanner = await this.bottomBannerRepository.findOne({ where: { _id: objectId } } as any);
    ...
    async findOneMiddleBanner(id: string | ObjectId) {
        ...
        const middleBanner = await this.middleBannerRepository.findOne({ where: { _id: objectId } } as any);
